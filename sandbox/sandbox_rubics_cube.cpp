...
int main() {
    ...
    // ── Shaders ───────────────────────────────────────────────────────────────
    GLuint litProg   = buildShaderProgram(LIT_VERT,   LIT_FRAG);
    GLuint unlitProg = buildShaderProgram(UNLIT_VERT, UNLIT_FRAG);
    ...
    std::array<GLuint, 6> textures = {
        ...
        sendTexDataToGPU("../sandbox/textures/face_bottom.webp"),  // bottom not visible
    };
